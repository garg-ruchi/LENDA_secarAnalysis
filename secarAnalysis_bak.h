...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<int>     *chan_BGO;
   vector<int>     *energy_BGO;
   vector<double>  *time_BGO;
   Int_t           mult_BGO;
...
void secarAnalysis::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("chan_BGO", &chan_BGO, &b_chan_BGO);
   fChain->SetBranchAddress("energy_BGO", &energy_BGO, &b_energy_BGO);
   fChain->SetBranchAddress("time_BGO", &time_BGO, &b_time_BGO);
   fChain->SetBranchAddress("mult_BGO", &mult_BGO, &b_m_BGO);
